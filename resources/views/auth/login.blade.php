...
<body class="min-h-screen grid grid-cols-1 md:grid-cols-2 bg-white font-sans text-gray-800">
    ...
    <section class="flex flex-col justify-center px-10 py-16">
        <div class="max-w-md w-full mx-auto space-y-8">
            ...
            {{-- Title --}}
            <h2 class="text-4xl font-bold text-[#2a47ff] text-center">Login To Your Account</h2>
<p class="text-lg text-center ">Welcome back! Please enter your details.</p>
            {{-- Success Alert --}}
            @if (session('success'))
            ...
            <form method="POST" action="{{ route('login') }}" class="space-y-6">
                ...
                <div>
                    ...
                    <input type="email" name="email" id="email" required autofocus class="mt-1 w-full px-4 py-2 border rounded-xl shadow-sm focus:ring-[#2a47ff] focus:border-[#2a47ff]">
                </div>

                <div>
                    <label for="password" class="block text-sm font-medium text-gray-700">Password</label>
                    <input type="password" name="password" id="password" required class="mt-1 w-full px-4 py-2 border rounded-xl shadow-sm focus:ring-[#2a47ff] focus:border-[#2a47ff]">
                </div>

                {{-- <div class="flex justify-between items-center text-sm">
                    <a href="#" class="text-[#2a47ff] hover:underline">Forgot password?</a>
                </div> --}}
            ...
            <p class="text-sm text-center text-gray-600">
                ...
                <a href="{{ route('register') }}" class="text-[#2a47ff] hover:underline">Register</a>
            </p>
