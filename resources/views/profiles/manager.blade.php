...
<body class="flex flex-row">
  ...
  <aside class="w-1/4">
    <div class="bg-white p-4 h-full shadow rounded">
      ...
      <nav>
        <ul class="space-y-4">
          <li><a class="text-black no-underline" href="{{ route('profiles.manager') }}">My Profile</a></li>
          <li><a class="text-black no-underline" href="{{ route('dashboard.manager') }}">Dashboard</a></li>
          <li>
